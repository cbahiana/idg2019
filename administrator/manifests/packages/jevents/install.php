...
class Pkg_JeventsInstallerScript
{
	...
	public function postflightHandler($type, $parent)
	{
		...
		echo "<div class='jev_install'>
				...
				<div class='version'><h2 class='gsl-h2'>" . $inst_text . ": 3.6.6 </h2></div>
		...
		{
			$app->enqueueMessage("<div class='jev_logo'><img src='https://www.jevents.net/logo/JeventsTransparent3.png' /></div>" . Text::_('JEV_INST_VERSION_UPRG') . " :: 3.6.6", 'message');
		}
